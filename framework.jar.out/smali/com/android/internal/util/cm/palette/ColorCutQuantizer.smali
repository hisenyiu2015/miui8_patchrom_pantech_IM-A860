...
# direct methods
.method static synthetic -get0(Lcom/android/internal/util/cm/palette/ColorCutQuantizer;)Landroid/util/SparseIntArray;
    .locals 1
...
.method static synthetic -get1(Lcom/android/internal/util/cm/palette/ColorCutQuantizer;)[I
    .locals 1
...
.method static synthetic -wrap0(Lcom/android/internal/util/cm/palette/ColorCutQuantizer;III)V
    .locals 0
...
.method private constructor <init>(Lcom/android/internal/util/cm/palette/ColorHistogram;I)V
    ...
    iput-object v8, p0, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->mTempHsl:[F
    ...
    .line 89
    .local v2, "rawColorCount":I
    invoke-virtual {p1}, Lcom/android/internal/util/cm/palette/ColorHistogram;->getColors()[I

    move-result-object v4

    .line 90
    .local v4, "rawColors":[I
    invoke-virtual {p1}, Lcom/android/internal/util/cm/palette/ColorHistogram;->getColorCounts()[I

    move-result-object v3

    .line 94
    .local v3, "rawColorCounts":[I
    new-instance v8, Landroid/util/SparseIntArray;

    invoke-direct {v8, v2}, Landroid/util/SparseIntArray;-><init>(I)V

    iput-object v8, p0, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->mColorPopulations:Landroid/util/SparseIntArray;
    ...
    .line 96
    iget-object v8, p0, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->mColorPopulations:Landroid/util/SparseIntArray;

    aget v9, v4, v1

    aget v10, v3, v1

    invoke-virtual {v8, v9, v10}, Landroid/util/SparseIntArray;->append(II)V
    ...
    iput-object v8, p0, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->mColors:[I

    .line 101
    const/4 v5, 0x0

    .line 102
    .local v5, "validColorCount":I
    array-length v9, v4
    ...
    .end local v5    # "validColorCount":I
    .local v6, "validColorCount":I
    :goto_1
    if-ge v8, v9, :cond_1
    ...
    .line 103
    .local v0, "color":I
    invoke-direct {p0, v0}, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->shouldIgnoreColor(I)Z
    ...
    .end local v6    # "validColorCount":I
    .restart local v5    # "validColorCount":I
    aput v0, v10, v6
    ...
    .end local v5    # "validColorCount":I
    .restart local v6    # "validColorCount":I
    goto :goto_1
    ...
    iput-object v8, p0, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->mQuantizedColors:Ljava/util/List;

    .line 111
    iget-object v8, p0, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->mColors:[I
    ...
    invoke-direct {v11, v0, v12}, Lcom/android/internal/util/cm/palette/Palette$Swatch;-><init>(II)V
    ...
    invoke-direct {p0, v7, p2}, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->quantizePixels(II)Ljava/util/List;

    move-result-object v7

    iput-object v7, p0, Lcom/android/internal/util/cm/palette/ColorCutQuantizer;->mQuantizedColors:Ljava/util/List;
