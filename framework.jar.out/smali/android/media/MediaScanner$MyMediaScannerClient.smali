...
.method private endFile(Landroid/media/MediaScanner$FileEntry;ZZZZZ)Landroid/net/Uri;
    ...
    invoke-static {v4}, Landroid/media/MediaScanner;->-get14(Landroid/media/MediaScanner;)Landroid/media/MediaInserter;
    ...
    invoke-static {v4}, Landroid/media/MediaScanner;->-get21(Landroid/media/MediaScanner;)Landroid/net/Uri;
    ...
    invoke-static {v5}, Landroid/media/MediaScanner;->-get16(Landroid/media/MediaScanner;)I
    ...
    invoke-static {v4}, Landroid/media/MediaScanner;->-get22(Landroid/media/MediaScanner;)Z
    ...
    invoke-static {v4}, Landroid/media/MediaScanner;->-get15(Landroid/media/MediaScanner;)Landroid/content/IContentProvider;
    ...
    invoke-static {v5}, Landroid/media/MediaScanner;->-get17(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    invoke-static {v4}, Landroid/media/MediaScanner;->-get13(Landroid/media/MediaScanner;)Landroid/net/Uri;
    ...
    invoke-static {v4}, Landroid/media/MediaScanner;->-get2(Landroid/media/MediaScanner;)Landroid/net/Uri;
    ...
    invoke-static {v4}, Landroid/media/MediaScanner;->-get5(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    invoke-static {v5}, Landroid/media/MediaScanner;->-get5(Landroid/media/MediaScanner;)Ljava/lang/String;
...
.method private setSettingIfNotSet(Ljava/lang/String;Landroid/net/Uri;J)V
    ...
    invoke-static {v1}, Landroid/media/MediaScanner;->-get4(Landroid/media/MediaScanner;)Landroid/content/Context;
...
.method public beginFile(Ljava/lang/String;Ljava/lang/String;JJZZ)Landroid/media/MediaScanner$FileEntry;
    ...
    invoke-static {v3}, Landroid/media/MediaScanner;->-get20(Landroid/media/MediaScanner;)Z
    ...
    invoke-static {v3}, Landroid/media/MediaScanner;->-get18(Landroid/media/MediaScanner;)Ljava/util/ArrayList;
