...
.method constructor <init>(Landroid/content/res/ThemeManager$2;Ljava/lang/String;)V
    .locals 0
    .param p1, "this$1"    # Landroid/content/res/ThemeManager$2;
...
.method public run()V
    ...
    invoke-static {v4}, Landroid/content/res/ThemeManager;->-get3(Landroid/content/res/ThemeManager;)Ljava/util/Set;
    ...
    check-cast v1, Landroid/content/res/ThemeManager$ThemeProcessingListener;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 120
    .local v1, "listener":Landroid/content/res/ThemeManager$ThemeProcessingListener;
    :try_start_1
    iget-object v4, p0, Landroid/content/res/ThemeManager$2$1;->val$pkgName:Ljava/lang/String;

    invoke-interface {v1, v4}, Landroid/content/res/ThemeManager$ThemeProcessingListener;->onFinishedProcessing(Ljava/lang/String;)V
    :try_end_1
    ...
    .end local v1    # "listener":Landroid/content/res/ThemeManager$ThemeProcessingListener;
    ...
    .line 128
    .restart local v1    # "listener":Landroid/content/res/ThemeManager$ThemeProcessingListener;
    iget-object v4, p0, Landroid/content/res/ThemeManager$2$1;->this$1:Landroid/content/res/ThemeManager$2;
