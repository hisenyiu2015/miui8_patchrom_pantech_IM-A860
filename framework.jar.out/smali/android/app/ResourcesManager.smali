...
.method private attachCommonAssets(Landroid/content/res/AssetManager;Landroid/content/res/ThemeConfig;)Z
    ...
    invoke-static {v11, v5}, Landroid/content/pm/ThemeUtils;->getTargetCacheDir(Ljava/lang/String;Landroid/content/pm/PackageInfo;)Ljava/lang/String;
...
.method private attachThemeAssets(Landroid/content/res/AssetManager;Landroid/content/res/ThemeConfig;)Z
    ...
    .line 597
    .end local v17    # "resourcePackageName":Ljava/lang/String;
    :goto_0
    :try_start_0
    invoke-static {}, Landroid/app/ResourcesManager;->getPackageManager()Landroid/content/pm/IPackageManager;
    ...
    .end local v14    # "piTarget":Landroid/content/pm/PackageInfo;
    .end local v15    # "piTheme":Landroid/content/pm/PackageInfo;
    :goto_1
    if-eqz v15, :cond_1
    ...
    .line 590
    .local v9, "basePackageName":Ljava/lang/String;
    .restart local v13    # "piAndroid":Landroid/content/pm/PackageInfo;
    .local v14, "piTarget":Landroid/content/pm/PackageInfo;
    .local v15, "piTheme":Landroid/content/pm/PackageInfo;
    .restart local v17    # "resourcePackageName":Ljava/lang/String;
    :cond_2
    const/4 v3, 0x2
    ...
    invoke-static {v3, v15}, Landroid/content/pm/ThemeUtils;->getTargetCacheDir(Ljava/lang/String;Landroid/content/pm/PackageInfo;)Ljava/lang/String;
    ...
    const-string/jumbo v19, "/resources.apk"
